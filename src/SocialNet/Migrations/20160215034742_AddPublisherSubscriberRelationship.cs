...
{
    public partial class AddPublisherSubscriberRelationship : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscription", x => new { x.PublisherId, x.SubscriberId });
                    table.ForeignKey(
                        name: "FK_Subscription_ApplicationUser_PublisherId",
